...
```bash
git remote add encore encore://leap-app-hmz2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/leap-app-hmz2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/leap-app-hmz2/settings/integrations/github)
