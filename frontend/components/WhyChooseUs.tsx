...
export default function WhyChooseUs() {
  ...
  return (
    <section ref={ref} className="py-20 md:py-28 bg-gradient-to-b from-background to-slate-950/30">
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`inline-flex items-center justify-center w-14 h-14 rounded-lg bg-gradient-to-br ${feature.gradient} mb-4 group-hover:scale-125 transition-transform duration-300 shadow-lg`}>
                  <feature.icon className="w-7 h-7 text-white" />
                </div>
                
                <h3 className="text-xl md:text-2xl font-bold mb-3 group-hover:text-white transition-colors duration-300">{feature.title}</h3>
                <p className="text-muted-foreground group-hover:text-white/90 transition-colors duration-300 leading-relaxed">{feature.description}</p>
              </div>
