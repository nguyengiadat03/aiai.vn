// Code generated by the Encore v1.51.9 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-leap-app-hmz2.encr.app`
}
...
/**
 * Client is an API client for the leap-app-hmz2 Encore application.
 */
export class Client {
...
export namespace blog {
    ...
    export class ServiceClient {
         ...
         */
        public async list(): Promise<ResponseType<typeof api_blog_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/blog/posts`, {method: "GET", body: undefined})
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "leap-app-hmz2-Generated-TS-Client (Encore/v1.51.9)";
        }
